...
public class AirBnbListings implements Serializable {
	...
	public AirBnbListings(Integer id, String name, Integer host_id, String host_name, String neighbourhood_group,
			String neighbourhood, Double latitude, Double longitude, String room_type, Integer price,
	...
	public String toString() {
		return "AirBnbListings [id=" + id + ", name=" + name + ", host_id=" + host_id + ", host_name=" + host_name
				+ ", neighbourhood_group=" + neighbourhood_group + ", neighbourhood=" + neighbourhood + ", latitude="
				+ latitude + ", longitude=" + longitude + ", room_type=" + room_type + ", price=" + price
				+ ", minimum_nights=" + minimum_nights + ", number_of_reviews=" + number_of_reviews + ", last_review="
				+ last_review + ", reviews_per_month=" + reviews_per_month + ", calculated_host_listings_count="
				+ calculated_host_listings_count + ", availability_365=" + availability_365 + "]";
	}
